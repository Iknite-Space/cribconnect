...
func NewControllerHandler(querier repo.Querier, service *Service, middleware *middleware.Middleware, campayClient *payment.Requests, manager *utils.ConnectionManager) *UserHandler {
	handler := &UserHandler{
		querier:      querier,
		service:      service,
